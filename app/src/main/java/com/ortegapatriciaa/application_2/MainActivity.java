...
public class MainActivity extends AppCompatActivity
    ...
    TextView sname, email, birthdate, username;
    Button btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sname = (TextView) findViewById(R.id.user_name);
        email = (TextView) findViewById(R.id.user_email);
        birthdate = (TextView) findViewById(R.id.user_birthdate);
        ...
        //sname.setText((CharSequence) databaseReference.child(Common.currentUser.getName()));
        sname.setText(Common.currentUser.getName());
        email.setText(Common.currentUser.getEmail());
        birthdate.setText(Common.currentUser.getBirthdate());
